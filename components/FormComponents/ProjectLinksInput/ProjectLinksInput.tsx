          ...
          <div key={field.id} className={cx("govuk-form-group lbh-form-group")}>
            <fieldset className="govuk-fieldset">
              ...
              <div className="repeaterGroup">
                <TextInput
                  name={`projectLinks.${index}.linkName`}
                  label="Link Name"
                  required={true}
                  rules={{ required: "The origin of the link is required" }}
                  register={register}
                  error={errors?.projectLinks?.[index]?.linkName}
                />
                <TextInput
                  ...
                  required={true}
                  register={register}
                  error={errors?.projectLinks?.[index]?.link}
                />
                <button
                  type="button"
